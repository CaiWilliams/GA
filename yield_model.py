...
class Sun:
    ...
    def load_earth_periodic_terms(self):
        ...
        filesdirs = [os.path.join(dir, i) for i in files]
    ...
    def load_nutation_coeffs(self):
        ...
        data = np.genfromtxt(os.path.join(os.getcwd(),dir,file), delimiter=',', skip_header=1)
...
class Module:
    ...
    def Perez_Diffuse_Irradiance(self):
        ...
        Coefficients = np.loadtxt(os.path.join(os.getcwd(),'Perez','Coefficients.csv'),delimiter=',',skiprows=1)
