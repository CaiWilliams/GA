...
class Population:
    ...
    def breed(self, n):
        ...
        Children_n = len(breeding_pool) #+ len(self.best_n_idx)
        mothers = np.random.choice(breeding_pool, Children_n, p=breeding_pool_weight)
        fathers = np.random.choice(breeding_pool, Children_n, p=breeding_pool_weight)
    ...
    def next_generation(self):
        ...
        TNG[len(self.best_n_idx):] = self.breed(self.population_number - len(self.best_n_idx)-len(self.worst_n_idx))
        self.population = TNG
